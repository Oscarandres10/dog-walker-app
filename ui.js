function eventos() {
  document
    .querySelector("#btnRegistarCliente")
    .addEventListener("click", registroInterfazUI); // Registrarse
  document
    .querySelector("#btnLoginCliente")
    .addEventListener("click", loginInterfazUI);
  document
    .querySelector("#btnNosotros")
    .addEventListener("click", mostrarSobreNosotrosUI);
  document.querySelector("#btnOtro").addEventListener("click", otroUI);
  document
    .querySelector("#btnPaseadorRegistro")
    .addEventListener("click", serUnPaseadorUI);
  document
    .querySelector("#btnRegistrarme")
    .addEventListener("click", almacenarUI);
  document.querySelector("#btnLogin").addEventListener("click", loginUI);
  document
    .querySelector("#btnLogoutCliente")
    .addEventListener("click", logoutUI);
...
function mostrarSeccionClienteUI() {
  ...
  if (tieneContrato) {
    ...
    document
      .querySelector("#selPaseadoresParaCliente")
      .addEventListener("change", mostrarPaseadoreUI);
  }
}
...
function mostrarSelectPaseadoresUI() {
  ...
  document.querySelector("#selPaseadoresParaCliente").innerHTML =
    selectPaseadores;
}
...
function mostrarSeccionPaseadorUI() {
  if (miSistema.logueado !== null) {
    document.querySelector("#sectionPaseadoresLogueado").style.display =
      "block";
...
function mostrarTablaContratacionesPendientesUI() {
  let seccionPaseador = document.querySelector(
...
function darVidaBotonesTablaContratacionesPendientesUI() {
  let botonAceptar = document.querySelectorAll(
    ".botonesTablaContratacionesPendiente"
  );
...
function gestionContratacionesProcensandoUI() {
  ...
  document.querySelector("#mostrarTablaContratacionesPendientes").innerHTML =
    laTabla;
...
function almacenarUI() {
  ...
  let validaciones = miSistema.validacionRegistroCliente(
    nombre,
    usuario,
    contrasenia,
    nombrePerro,
  ...
  document.querySelector("#pRegistrarse").innerHTML =
    miSistema.mensajeRegistro.join("");
